...
class flowplayer3 {
	 ...
	 * @param string $imagetitle the filename of the movie to be passed to the player for display (within slideshow), if empty (within albums) the function getImageTitle() is used
