<?php
	...
	define('PAGINATION_ITEMS_PER_PAGE', 'Wyświetl %s pozycji na strone');
	...
	define('LBL_SEARCH_RECURSIVELY', 'Rekursywne przeszukiwanie:');
	...
	define('CALENDAR_SAT', 'Sb');
	define('CALENDAR_SUN', 'N');
	define('CALENDAR_JAN', 'Stycz');
	define('CALENDAR_FEB', 'Luty');
	define('CALENDAR_MAR', 'Marz');
	define('CALENDAR_APR', 'Kw');
	define('CALENDAR_MAY', 'Maj');
	define('CALENDAR_JUN', 'Cz');
	define('CALENDAR_JUL', 'Lip');
	define('CALENDAR_AUG', 'Sierp');
	define('CALENDAR_SEP', 'Wrz');
	define('CALENDAR_OCT', 'Paź');
	define('CALENDAR_NOV', 'List');
	define('CALENDAR_DEC', 'Grudz');
	//ERROR MESSAGES
		//deletion
	...
	//88888888888   Below for Image Editor   888888888888888888888
		//Warning 
		define('IMG_WARNING_NO_CHANGE_BEFORE_SAVE', "Nie można dokonać żadnych zmian w obrazku.");
		...
		define('IMG_WARNING_EMPTY_RESET', 'Jeszcze nie zostały dokonane żadne zmiany w obrazku.');
		...
		//Label
			...
			define('IMG_LBL_SAVE_AS', 'Formularz zapisz jako');
