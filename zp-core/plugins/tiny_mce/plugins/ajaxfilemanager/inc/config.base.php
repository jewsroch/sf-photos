...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	define('CONFIG_UPLOAD_MAXSIZE', 104857600); //by bytes - 100 MB should be enough,right?
	...
	define('CONFIG_UPLOAD_VALID_EXTS', 'gif,jpg,jpeg,png,bmp,tif,zip,sit,rar,gz,tar,htm,html,mov,mpg,avi,asf,mpeg,wmv,aif,aiff,wav,mp3,swf,ppt,rtf,doc,pdf,xls,txt,xml,xsl,dtd');//
	define("CONFIG_VIEWABLE_VALID_EXTS", 'gif,flv,txt,jpg,png,tif,html,htm,js,css,xml,xsl,dtd,mp3,wav,wmv,mov,swf,pdf');
