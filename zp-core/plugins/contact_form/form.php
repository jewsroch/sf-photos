...
<form id="mailform" action="<?php echo sanitize($_SERVER['REQUEST_URI']); ?>" method="post" accept-charset="UTF-8">
	...
	<table border="0">
		...
		<tr>
			...
			<td><input type="text" id="title" name="title" size="50" value="<?php echo $mailcontent['title']; ?>"<?php if ($_processing_post) echo ' DISABLED';?> />
			</td>
		</tr>
		<?php } ?>
		...
		<tr>
			...
			<td><input type="text" id="name" name="name" size="50" value="<?php echo $mailcontent['name']; ?>"<?php if ($_processing_post) echo ' DISABLED'; ?> />
			</td>
		</tr>
		<?php } ?>
		...
		<tr>
			...
			<td><input type="text" id="company" name="company" size="50" value="<?php echo $mailcontent['company']; ?>"<?php if ($_processing_post) echo ' DISABLED'; ?> />
			</td>
		</tr>
		<?php } ?>
		<?php if(showOrNotShowField(getOption('contactform_title'))) { ?>
		<tr>
			...
			<td><input type="text" id="street" name="street" size="50" value="<?php echo $mailcontent['street']; ?>"<?php if ($_processing_post) echo ' DISABLED'; ?> />
			</td>
		</tr>
		<?php } ?>
		...
		<tr>
			...
			<td><input type="text" id="city" name="city" size="50" value="<?php echo $mailcontent['city']; ?>"<?php if ($_processing_post) echo ' DISABLED'; ?> />
			</td>
		</tr>
		<?php } ?>
  	...
  	<tr>
			...
			<td><input type="text" id="country" name="country" size="50" value="<?php echo $mailcontent['country']; ?>"<?php if ($_processing_post) echo ' DISABLED'; ?> />
			</td>
		</tr>
		<?php } ?>
		...
		<tr>
			...
			<td><input type="text" id="email" name="email" size="50" value="<?php echo $mailcontent['email']; ?>"<?php if ($_processing_post) echo ' DISABLED'; ?> />
			</td>
		</tr>
		<?php } ?>
		...
		<tr>
			...
			<td><input type="text" id="website" name="website" size="50" value="<?php echo $mailcontent['website']; ?>"<?php if ($_processing_post) echo ' DISABLED'; ?> />
			</td>
		</tr>
		<?php } ?>
		...
		<tr>
			...
			<td><input type="text" id="phone" name="phone" size="50" value="<?php echo $mailcontent['phone']; ?>"<?php if ($_processing_post) echo ' DISABLED'; ?> /></td>
		</tr>
		<?php } ?>
		...
		<tr>
			...
			<td><input type="text" id="subject" name="subject" size="50" value="<?php echo $mailcontent['subject']; ?>"<?php if ($_processing_post) echo ' DISABLED'; ?> /></td>
		</tr>
		<?php } ?>
		...
		<tr>
			...
			<td><textarea id="message" name="message" rows="5" cols="39" <?php if ($_processing_post) echo ' DISABLED'; ?>><?php echo $mailcontent['message']; ?></textarea></td>
		</tr>
		<?php } ?>
