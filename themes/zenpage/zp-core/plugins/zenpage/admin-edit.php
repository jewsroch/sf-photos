...
<?php } ?>
  <table>
    ...
    <tr> 
			...
			<td class="topalign-padding"><?php print_language_string_list_zenpage(sanitize(htmlentities(getIfObject($result,"content"),ENT_COMPAT,getOption("charset")),0),"content",TRUE) ;?></td>
    </tr>
    <tr> 
			<td class="topalign-padding"><?php echo gettext("ExtraContent:"); ?></td>
			<td><?php print_language_string_list_zenpage(sanitize(htmlentities(getIfObject($result,"extracontent"),ENT_COMPAT,getOption("charset")),0),"extracontent",TRUE) ;?></td>
