...
<?php 
	...
	echo "<div id=\"main\">";
	printTabs("zenpage"); 
	setPluginDomain("zenpage");
	echo "<div id=\"content\">";
	zenpageAdminnav("categories"); 
...
<?php if(isset($_GET["edit"])) { ?>
	<form method="post" name="update" action="admin-categories.php?edit&amp;update">
	<input type="hidden" name="id" value="<?php echo $result['id'];?>" />
	<input type="hidden" name="catlink-old" type="text" id="catlink-old" value="<?php echo $result['cat_link']; ?>" />
<?php } else { ?>
	<form method="post" name="addcat" action="admin-categories.php?save">
<?php } ?>
		<table>
     <tr> 
     <?php
...
<?php } ?>
    <tr>
     ...
     if(isset($_GET['edit'])) { 
     	...
     	?>
      	<p class="buttons"><button type="submit" title="<?php echo $submittext; ?>"><img src="../../images/pass.png" alt="" /><strong><?php echo $submittext; ?></strong></button></p>
				<p class="buttons"><button type="reset" title="<?php echo gettext("Reset"); ?>"><img src="../../images/reset.png" alt="" /><strong><?php echo gettext("Reset"); ?></button></strong></p>
