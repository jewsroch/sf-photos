...
function printZenpageRSSLink($option='News', $categorylink='', $prev='', $linktext='', $next='', $printIcon=true, $class=null, $lang='') {
	...
	switch($option) {
		case "News":
			echo $prev."<a $class href=\"http://".$host.WEBPATH."/rss-news.php?lang=".$lang."\" rel=\"nofollow\">".$linktext."$icon</a>".$next;
			break;
		case "Category":
			echo $prev."<a $class href=\"http://".$host.WEBPATH."/rss-news.php?lang=".$lang.$categorylink."\" rel=\"nofollow\">".$linktext."$icon</a>".$next;
			break;
		case "NewsWithImages":
			echo $prev."<a $class href=\"http://".$host.WEBPATH."/rss-news.php?withimages&amp;lang=".$lang."\" rel=\"nofollow\">".$linktext."$icon</a>".$next;
			break;
		case "Comments":
			echo $prev."<a $class href=\"http://".$host.WEBPATH."/rss-news-comments.php?lang=".$lang."\" rel=\"nofollow\">".$linktext."$icon</a>".$next;
			break;
		case "Comments-news":
			echo $prev."<a $class href=\"http://".$host.WEBPATH."/rss-news-comments.php?id=".getNewsID()."&amp;title=".urlencode(getNewsTitle())."&amp;type=news&amp;lang=".$lang."\" rel=\"nofollow\">".$linktext."$icon</a>".$next;
			break;
		case "Comments-page":
			echo $prev."<a $class href=\"http://".$host.WEBPATH."/rss-news-comments.php?id=".getPageID()."&amp;title=".urlencode(getPageTitle())."&amp;type=page&amp;lang=".$lang."\" rel=\"nofollow\">".$linktext."$icon</a>".$next;
			break;
	}
}
