...
class zenpagecms {
	...
	function getOptionsSupported() {
		...
		gettext('CombiNews') => array('key' => 'zenpage_combinews', 'type' => 1,
										'desc' => gettext("Set to enable the CombiNews feature to show news articles and latest images together on the news section's overview page(s). <strong>NOTE:</strong> Images and news articles are still separate, your Zenphoto gallery is not touched in any way! <strong>IMPORTANT: This feature requires MySQL 4.1 or later.</strong>")),
		...
		gettext('CombiNews: Sized image size') => array('key' => 'zenpage_combinews_imagesize', 'type' => 0,
										'desc' => gettext("The size of the sized image shown the CombiNews section <em>(only in latestimages-sizedimage mode)</em>.")),
